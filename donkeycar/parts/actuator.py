...
class PCA9685:
    ...
    def set_high(self):
        self.pwm.channels[self.channel] = 0xFFFF

    def set_low(self):
        self.pwm.channels[self.channel] = 0x0
    ...
    def set_duty_cycle(self, duty_cycle):
        ...
        if duty_cycle == 1:
            ...
            # duty cycle is fraction of the 16 bits
            pulse = int(0xFFFF * duty_cycle)
            self.pwm.channels[self.channel].duty_cycle = pulse

    def set_pulse(self, pulse):
        self.pwm.channels[self.channel].duty_cycle = int(pulse * self.pwm_scale)
